...
typedef enum _meshtastic_Config_DeviceConfig_Role {
 ...
 Technical Details: Used for router nodes that are intended to provide additional coverage
    ...
    consuming hops. */
    meshtastic_Config_DeviceConfig_Role_ROUTER_INFILL = 11
...
#define _meshtastic_Config_DeviceConfig_Role_MAX meshtastic_Config_DeviceConfig_Role_ROUTER_INFILL
#define _meshtastic_Config_DeviceConfig_Role_ARRAYSIZE ((meshtastic_Config_DeviceConfig_Role)(meshtastic_Config_DeviceConfig_Role_ROUTER_INFILL+1))
